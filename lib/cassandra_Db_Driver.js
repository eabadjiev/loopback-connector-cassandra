...
util.inherits(cassandraDB, SqlConnector);
...
cassandraDB.prototype.connect = function (callback) {
  ...
  client =new self.cassandra_driver.Client( { contactPoints : contact_Points ,keyspace:key_space} ); 
...
cassandraDB.prototype.all = function all(model, filter, callback) {
  var self = this;
